...
const leaderboardData = [
  ...
  { rankF1: 15, rankConf: '', author: 'Hugo Abraham Velez Perez', f1: '0.3158', institution: 'Bioingeniería Traslacional CUCEI Universidad de Guadalajara', model: 'Ensemble of 3 LSTM' },
  { rankF1: 16, rankConf: '', author: 'Elakkat D Gireesh', f1: '0.3138', institution: 'AdventHealth Orlando Florida USA', model: 'Vision transformer' },
  { rankF1: 17, rankConf: '', author: 'Matteo Moro', f1: '0.3137', institution: 'DIBRIS and MaLGa University of Genova', model: 'Ensemble model based on majority voting over three ST-GCN-MMAction2' },
  { rankF1: 18, rankConf: '', author: 'Philip Ridder', f1: '0.3006', institution: 'Knappschaft Kliniken University Hospital Bochum', model: 'Time Series Based machine learning classifier' },
  { rankF1: 19, rankConf: '', author: 'Babajide Owoyele', f1: '0.2975', institution: 'Hasso Plattner Institute Postdam Germany', model: 'Dual-architecture ensemble of CNN-GRU and Temporal Convolutional Network (TCN)' },
  { rankF1: 20, rankConf: '', author: 'Alejandro Diaz Montes de Oca', f1: '0.2915', institution: 'Universidad de Guadalajara', model: 'XGBoost-Savitzky Golay filter' },
  { rankF1: 21, rankConf: '', author: 'Nagham Daood', f1: '0.2682', institution: 'University of Haifa', model: 'Ensemble of five Spatio-Temporal Virtual Graph (STViG)' },
  { rankF1: 22, rankConf: '', author: 'Ahmed Alramly', f1: '0.2515', institution: 'Frankfurt Institute for Advanced Studies', model: 'Conv3d' },
  { rankF1: 23, rankConf: '', author: 'Preeti Ramesh', f1: '0.2', institution: 'University of Southern California', model: 'MultiChannelCNN' },
  { rankF1: 24, rankConf: '', author: 'Ahmed Alramly', f1: '0.1856', institution: 'Frankfurt Institute for Advanced Studies', model: 'Conv2d' },
  { rankF1: 25, rankConf: '', author: 'Xiaoling Huang', f1: '0.1731', institution: 'University of Alabama at Birmingham', model: 'Graph spatial-temporal' },
  { rankF1: 26, rankConf: '', author: 'Surya Pandiaraju', f1: '0.1453', institution: 'Johns Hopkins University', model: 'Ensemble of 1D ResNet and XGBoost' },
